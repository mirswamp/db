...
select count(1) into @platform_already_exists from platform_store.platform where platform_uuid = '4604e180-7c3a-11e6-88bc-001a4a81450b';
SET @s = IF(@platform_already_exists = 0,
            'INSERT INTO platform_store.platform (platform_uuid, platform_sharing_status, name) VALUES (''4604e180-7c3a-11e6-88bc-001a4a81450b'',''PUBLIC'',''CentOS Linux 5 32-bit'');',
            'DO SLEEP(0)');
PREPARE stmt1 FROM @s;
EXECUTE stmt1;

# Platform Version
delete from platform_store.platform_version where platform_version_uuid = '73c7f6be-7c3a-11e6-88bc-001a4a81450b';
...
delete from tool_shed.tool_platform where platform_uuid = '4604e180-7c3a-11e6-88bc-001a4a81450b';
insert into tool_shed.tool_platform (platform_uuid, tool_uuid)
select '4604e180-7c3a-11e6-88bc-001a4a81450b', t.tool_uuid
