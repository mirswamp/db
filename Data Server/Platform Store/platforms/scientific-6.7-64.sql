...
SET @s = IF(@platform_already_exists = 0,
            'INSERT INTO platform_store.platform (platform_uuid, platform_sharing_status, name) VALUES (''d95fcb5f-209d-11e3-9a3e-001a4a81450b'',''PUBLIC'',''Scientific Linux 6 64-bit'');',
            'DO SLEEP(0)');
...
delete from tool_shed.tool_platform where platform_uuid = 'd95fcb5f-209d-11e3-9a3e-001a4a81450b';
insert into tool_shed.tool_platform (platform_uuid, tool_uuid)
select 'd95fcb5f-209d-11e3-9a3e-001a4a81450b', t.tool_uuid
