...
SET @s = IF(@platform_already_exists = 0,
            'INSERT INTO platform_store.platform (platform_uuid, platform_sharing_status, name) VALUES (''071890c4-7c3b-11e6-88bc-001a4a81450b'',''PUBLIC'',''CentOS Linux 6 64-bit'');',
            'DO SLEEP(0)');
PREPARE stmt1 FROM @s;
EXECUTE stmt1;

# Platform Version
delete from platform_store.platform_version where platform_version_uuid = '1c5cbe39-7c3b-11e6-88bc-001a4a81450b';
