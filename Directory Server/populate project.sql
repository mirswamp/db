...
insert into database_version (database_version_no, description) values (19, 'setup');
commit;
...
# Permission
insert into permission (permission_code, title, description, admin_only_flag, policy_code) values ('project-owner', 'Project Ownership', 'Permission to create new Projects.', 0, 'project-owner-policy');
insert into permission (permission_code, title, description, admin_only_flag, policy_code) values ('ssh-access', 'SSH Access', 'Permission to log in to assessment virtual machines using SSH.', 1, null);
...
insert into user_permission (user_permission_uid, permission_code, user_uid, request_date, grant_date) values (uuid(), 'project-owner', '80835e30-d527-11e2-8b8b-0800200c9a66', now(), now());
insert into user_policy (user_policy_uid, user_uid, policy_code, accept_flag) values (uuid(), '80835e30-d527-11e2-8b8b-0800200c9a66', 'project-owner-policy', 1);
## project and project_user resords created by user_account_BINS trigger
...
##          values ('eccaf23e-1235-11e6-aba5-001a4a814425', '80835e30-d527-11e2-8b8b-0800200c9a66', 'MyProject', 'MyProject', 'Starter Project', null, 1);
##insert into project.project_user (project_uid, user_uid, membership_uid, admin_flag)
##          values ('eccaf23e-1235-11e6-aba5-001a4a814425', '80835e30-d527-11e2-8b8b-0800200c9a66', uuid(), 1);
