  ...
  BEGIN
    ...
    if cur_db_version_no < script_version_no then
      begin
        ...
        insert into project.permission (permission_code, title, description, admin_only_flag) values ('ssh-access', 'SSH Access', 'Permission to log in to assessment virtual machines using SSH.', 1);
