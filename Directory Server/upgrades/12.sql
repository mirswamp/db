  ...
  BEGIN
    ...
    if cur_db_version_no < script_version_no then
      begin
        ...
        insert into project.permission (permission_code, title, description, admin_only_flag, policy_code) values ('parasoft-user-c-test', 'Parasoft C/C++test User', 'Permission to access and use the C/C++test static analysis tool for C/C++ from Parasoft.', 0, 'parasoft-user-c-test-policy');
        insert into project.permission (permission_code, title, description, admin_only_flag, policy_code) values ('parasoft-user-j-test', 'Parasoft Jtest User', 'Permission to access and use the Jtest static analysis tool for Java from Parasoft.', 0, 'parasoft-user-j-test-policy');
